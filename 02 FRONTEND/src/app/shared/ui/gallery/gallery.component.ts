...
@Component({
  ...
  display: block !important;
    ...
    .superbox-show{text-align:left;position:
      relative;background-color:#222;
      width:200%;float:left;padding:50px 0 20px 25px;display:none;margin:5px 0}
      .superbox-current-img{max-width:350px;float:left;padding-right:25px;padding-bottom:13px}
      .superbox-img:hover{opacity:.8}.superbox-float{float:left}
      .superbox-imageinfo span{font-size:20px;color:#a19994;margin-right:-2px;padding-top:10px;display:inline-block;padding-bottom:13px}
