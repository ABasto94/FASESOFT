...
import com.fasesoft.negocio.NegocioFasPagos;
...
/**
 * Servicios REST para operaciones CRUD y de negocio sobre la entidad FasPagos
 * @author GeneradorCRUD
 */
@Stateless
@Path("servicios/faspagos")
public class ServicioFasPagos {

    @EJB
    private NegocioFasPagos negocioFasPagos;

    /**
     * Variable estatica para imprimir logs...
     */
    private static final Logger logger = Logger.getLogger(ServicioFasPagos.class.getName());
    ...
    public List<FasPagosDTO> consultar(@QueryParam("filterBy") String filterBy, 
        ...
        return negocioFasPagos.consultar(filterBy, orderBy, from, to);
     ...
     * @return El identificador de la insntancia de FasPagos recién creado
     */
    @POST
    ...
    public FasPagosDTO crear(FasPagosDTO fasPagosDTO) {
        ...
        return negocioFasPagos.crear(fasPagosDTO);
        // protected region Use esta region para su implementacion end 
     ...
     * @return El identificador de la instancia de la entidad FasPagos que ha sido actualizado
     */
    @PUT
    @Consumes({APPLICATION_JSON})
    @Produces({APPLICATION_JSON})
    public FasPagosDTO actualizar(FasPagosDTO fasPagosDTO){
        ...
        return negocioFasPagos.actualizar(fasPagosDTO);
        // protected region Use esta region para su implementacion end
    }
     ...
     */
    @DELETE
    public String eliminar(@QueryParam("idPago") BigDecimal idPago) {
        // protected region Use esta region para su implementacion on begin

        return negocioFasPagos.eliminar(idPago);
        // protected region Use esta region para su implementacion end
    }
    ...
    public String contar(@QueryParam("filterBy") String filterBy,
        ...
        return negocioFasPagos.contar(filterBy, from, to);
        // protected region Use esta region para su implementacion end
    }    
    ...
    public List<String> consultarLista(@QueryParam("filterBy") String filterBy,
        ...
        // protected region Use esta region para su implementacion on begin
        return negocioFasPagos.consultarLista(filterBy, orderBy, atributo);
        // protected region Use esta region para su implementacion end
    }     
    ...
    @Path("pagos")
    @Produces({APPLICATION_JSON})
    public List<FasDetallePagoDTO> consultarPagos() throws InvalidParameterException{
        // protected region Use esta region para su implementacion on begin
        return negocioFasPagos.consultarPagos();
        // protected region Use esta region para su implementacion end
    }     
