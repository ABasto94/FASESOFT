...
import com.fasesoft.negocio.NegocioFasConvenios;
...
/**
 * Servicios REST para operaciones CRUD y de negocio sobre la entidad FasConvenios
 * @author GeneradorCRUD
 */
@Stateless
@Path("servicios/fasconvenios")
public class ServicioFasConvenios {

    @EJB
    private NegocioFasConvenios negocioFasConvenios;

    /**
     * Variable estatica para imprimir logs...
     */
    private static final Logger logger = Logger.getLogger(ServicioFasConvenios.class.getName());
    ...
    public List<FasConveniosDTO> consultar(@QueryParam("filterBy") String filterBy, 
        ...
        return negocioFasConvenios.consultar(filterBy, orderBy, from, to);
     ...
     * @return El identificador de la insntancia de FasConvenios recién creado
     */
    @POST
    ...
    public FasConveniosDTO crear(FasConveniosDTO fasConveniosDTO) {
        ...
        return negocioFasConvenios.crear(fasConveniosDTO);
        // protected region Use esta region para su implementacion end 
     ...
     * @return El identificador de la instancia de la entidad FasConvenios que ha sido actualizado
     */
    @PUT
    @Consumes({APPLICATION_JSON})
    @Produces({APPLICATION_JSON})
    public FasConveniosDTO actualizar(FasConveniosDTO fasConveniosDTO){
        ...
        return negocioFasConvenios.actualizar(fasConveniosDTO);
        // protected region Use esta region para su implementacion end
    }
     ...
     */
    @DELETE
    public String eliminar(@QueryParam("idConvenio") Integer idConvenio) {
        // protected region Use esta region para su implementacion on begin

        return negocioFasConvenios.eliminar(idConvenio);
        // protected region Use esta region para su implementacion end
    }
    ...
    public String contar(@QueryParam("filterBy") String filterBy,
        ...
        return negocioFasConvenios.contar(filterBy, from, to);
        // protected region Use esta region para su implementacion end
    }    
    ...
    public List<String> consultarLista(@QueryParam("filterBy") String filterBy,
        ...
        // protected region Use esta region para su implementacion on begin
        return negocioFasConvenios.consultarLista(filterBy, orderBy, atributo);
        // protected region Use esta region para su implementacion end
    }     
    ...
    @Path("misconvenios")
    @Produces({APPLICATION_JSON})
    public List<FasConveniosDTO> consultarPorUsuario(@QueryParam("correo") String correo) throws InvalidParameterException{
    	return negocioFasConvenios.consultarPorUsuario(correo);
    }
