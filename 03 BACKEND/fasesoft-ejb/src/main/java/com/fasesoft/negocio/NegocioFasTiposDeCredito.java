...
/**
 * Servicios para operaciones CRUD y de negocio sobre la entidad FasTiposDeCredito
 * @author GeneradorCRUD
 */
@Stateless
public class NegocioFasTiposDeCredito extends NegocioAbstracto<FasTiposDeCredito,FasTiposDeCreditoDTO> {

    @EJB
    private ManejadorFasTiposDeCredito manejadorFasTiposDeCredito;

    /**
     * Variable estatica para imprimir logs...
     */
    private static final Logger logger = Logger.getLogger(NegocioFasTiposDeCredito.class.getName());
     ...
     */
    public List<FasTiposDeCreditoDTO> consultar(String filterBy, 
        ...
        return convertirListaEntidadesADao(manejadorFasTiposDeCredito.consultar(filtros, ordenamiento, rango));
     ...
     * @return La insntancia de FasTiposDeCredito recién creado
     */
    public FasTiposDeCreditoDTO crear(FasTiposDeCreditoDTO fasTiposDeCreditoDTO) {
        ...
        logService(this.getClass().getName(), "crear", fasTiposDeCreditoDTO);

        FasTiposDeCredito fasTiposDeCredito = new FasTiposDeCredito();
        copiarPropiedades(fasTiposDeCredito, fasTiposDeCreditoDTO);
        
        manejadorFasTiposDeCredito.crear(fasTiposDeCredito);

        return fasTiposDeCreditoDTO;
     ...
     * @return La instancia de la entidad FasTiposDeCredito que ha sido actualizado
     */
    public FasTiposDeCreditoDTO actualizar(FasTiposDeCreditoDTO fasTiposDeCreditoDTO){
        ...
        logService(this.getClass().getName(), "actualizar", fasTiposDeCreditoDTO);

        FasTiposDeCredito fasTiposDeCredito = manejadorFasTiposDeCredito.buscar(fasTiposDeCreditoDTO.getIdTipo());                
        copiarPropiedades(fasTiposDeCredito, fasTiposDeCreditoDTO);
        
        manejadorFasTiposDeCredito.actualizar(fasTiposDeCredito);
     ...
     */
    public String eliminar(BigDecimal idTipo) {
        // protected region Modifique el metodo eliminar on begin

        logService(this.getClass().getName(), "eliminar", idTipo);
        manejadorFasTiposDeCredito.eliminarPorId(idTipo);
        
		
		StringBuilder valores = new StringBuilder();
		valores.append(String.valueOf(idTipo));
    ...
    public String contar(String filterBy,
        ...
        return String.valueOf(manejadorFasTiposDeCredito.consultarTotalRegistros(filtros, 
                    rango));
    ...
    public List<String> consultarLista(String filterBy,
        ...
        return UtilOperaciones.convertirListaObjetosAString(manejadorFasTiposDeCredito.consultarLista(filtros, ordenamiento, infoAgrupamiento));
    ...
    protected boolean entidadContieneAtributo(String nombreAtributo) {
        return FasTiposDeCredito.contieneAtributo(nombreAtributo);
    }
     ...
     */
    @Override
    protected FasTiposDeCreditoDTO instanciarDAO() {
        return new FasTiposDeCreditoDTO();
    }       
