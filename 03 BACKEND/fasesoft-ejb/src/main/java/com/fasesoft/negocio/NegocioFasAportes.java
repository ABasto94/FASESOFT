...
/**
 * Servicios para operaciones CRUD y de negocio sobre la entidad FasAportes
 * @author GeneradorCRUD
 */
@Stateless
public class NegocioFasAportes extends NegocioAbstracto<FasAportes,FasAportesDTO> {

    @EJB
    private ManejadorFasAportes manejadorFasAportes;

    /**
     * Variable estatica para imprimir logs...
     */
    private static final Logger logger = Logger.getLogger(NegocioFasAportes.class.getName());
     ...
     */
    public List<FasAportesDTO> consultar(String filterBy, 
        ...
        return convertirListaEntidadesADao(manejadorFasAportes.consultar(filtros, ordenamiento, rango));
     ...
     * @return La insntancia de FasAportes recién creado
     */
    public FasAportesDTO crear(FasAportesDTO fasAportesDTO) {
    	// protected region Modifique el metodo crear on begin
    	
        logService(this.getClass().getName(), "crear", fasAportesDTO);

        FasAportes fasAportes = new FasAportes();
        copiarPropiedades(fasAportes, fasAportesDTO);
        
        manejadorFasAportes.crear(fasAportes);

        return fasAportesDTO;
     ...
     * @return La instancia de la entidad FasAportes que ha sido actualizado
     */
    public FasAportesDTO actualizar(FasAportesDTO fasAportesDTO){
        // protected region Modifique el metodo actualizar on begin
    
        logService(this.getClass().getName(), "actualizar", fasAportesDTO);

        FasAportes fasAportes = manejadorFasAportes.buscar(fasAportesDTO.getIdAporte());                
        copiarPropiedades(fasAportes, fasAportesDTO);
        
        manejadorFasAportes.actualizar(fasAportes);
     ...
     */
    public String eliminar(BigDecimal idAporte) {
        // protected region Modifique el metodo eliminar on begin

        logService(this.getClass().getName(), "eliminar", idAporte);
        manejadorFasAportes.eliminarPorId(idAporte);
        
		
		StringBuilder valores = new StringBuilder();
		valores.append(String.valueOf(idAporte));
    ...
    public String contar(String filterBy,
        ...
        return String.valueOf(manejadorFasAportes.consultarTotalRegistros(filtros, 
                    rango));
    ...
    public List<String> consultarLista(String filterBy,
        ...
        return UtilOperaciones.convertirListaObjetosAString(manejadorFasAportes.consultarLista(filtros, ordenamiento, infoAgrupamiento));
    ...
    protected boolean entidadContieneAtributo(String nombreAtributo) {
        return FasAportes.contieneAtributo(nombreAtributo);
    }
     ...
     */
    @Override
    protected FasAportesDTO instanciarDAO() {
        return new FasAportesDTO();
    }       
