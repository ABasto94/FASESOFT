...
/**
 * Servicios para operaciones CRUD y de negocio sobre la entidad FasTiposDeAhorro
 * @author GeneradorCRUD
 */
@Stateless
public class NegocioFasTiposDeAhorro extends NegocioAbstracto<FasTiposDeAhorro,FasTiposDeAhorroDTO> {

    @EJB
    private ManejadorFasTiposDeAhorro manejadorFasTiposDeAhorro;

    /**
     * Variable estatica para imprimir logs...
     */
    private static final Logger logger = Logger.getLogger(NegocioFasTiposDeAhorro.class.getName());
     ...
     */
    public List<FasTiposDeAhorroDTO> consultar(String filterBy, 
        ...
        return convertirListaEntidadesADao(manejadorFasTiposDeAhorro.consultar(filtros, ordenamiento, rango));
     ...
     * @return La insntancia de FasTiposDeAhorro recién creado
     */
    public FasTiposDeAhorroDTO crear(FasTiposDeAhorroDTO fasTiposDeAhorroDTO) {
        ...
        logService(this.getClass().getName(), "crear", fasTiposDeAhorroDTO);

        FasTiposDeAhorro fasTiposDeAhorro = new FasTiposDeAhorro();
        copiarPropiedades(fasTiposDeAhorro, fasTiposDeAhorroDTO);
        
        manejadorFasTiposDeAhorro.crear(fasTiposDeAhorro);

        return fasTiposDeAhorroDTO;
     ...
     * @return La instancia de la entidad FasTiposDeAhorro que ha sido actualizado
     */
    public FasTiposDeAhorroDTO actualizar(FasTiposDeAhorroDTO fasTiposDeAhorroDTO){
        ...
        logService(this.getClass().getName(), "actualizar", fasTiposDeAhorroDTO);

        FasTiposDeAhorro fasTiposDeAhorro = manejadorFasTiposDeAhorro.buscar(fasTiposDeAhorroDTO.getIdTipoDeAhorro());                
        copiarPropiedades(fasTiposDeAhorro, fasTiposDeAhorroDTO);
        
        manejadorFasTiposDeAhorro.actualizar(fasTiposDeAhorro);
     ...
     */
    public String eliminar(Integer idTipoDeAhorro) {
        // protected region Modifique el metodo eliminar on begin

        logService(this.getClass().getName(), "eliminar", idTipoDeAhorro);
        manejadorFasTiposDeAhorro.eliminarPorId(idTipoDeAhorro);
        
		
		StringBuilder valores = new StringBuilder();
		valores.append(String.valueOf(idTipoDeAhorro));
    ...
    public String contar(String filterBy,
        ...
        return String.valueOf(manejadorFasTiposDeAhorro.consultarTotalRegistros(filtros, 
                    rango));
    ...
    public List<String> consultarLista(String filterBy,
        ...
        return UtilOperaciones.convertirListaObjetosAString(manejadorFasTiposDeAhorro.consultarLista(filtros, ordenamiento, infoAgrupamiento));
    ...
    protected boolean entidadContieneAtributo(String nombreAtributo) {
        return FasTiposDeAhorro.contieneAtributo(nombreAtributo);
    }
     ...
     */
    @Override
    protected FasTiposDeAhorroDTO instanciarDAO() {
        return new FasTiposDeAhorroDTO();
    }       
