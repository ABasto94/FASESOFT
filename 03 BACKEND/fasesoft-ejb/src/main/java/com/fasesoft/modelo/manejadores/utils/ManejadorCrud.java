...
import com.fasesoft.modelo.enums.TipoQuery;
import static com.fasesoft.modelo.utils.UtilConstantes.NOT_NULL_VALUE;
import static com.fasesoft.modelo.utils.UtilConstantes.NULL_VALUE;
import com.fasesoft.modelo.utils.UtilReflection;
...
public abstract class ManejadorCrud<T,U> implements IManejadorCrud<T,U> {
    ...
    /**
     * Método que se ejecuta antes de crear un registro en la base de datos y 
    ...
    /**
     * Método que se ejecuta antes de crear o actualizar un registro en la base de datos y 
     * en el que la clase que extienda esta clase puede añadir funcionalidad 
     * personalizada.
     */
    ...
    /**
     * Método que se ejecuta después de crear o actualizar un registro en la base de datos y 
     * en el que la clase que extienda esta clase puede añadir funcionalidad 
     * personalizada.
     */
    ...
    /**
     * Construye una consulta JPQL de tipo SELECT, DELETE o UPDATE para la tabla de la entidad T con
     * las condiciones de filtrado, ordenamiento, asignación, rango y agrupamiento especificadas según corresponda
     * al tipo de consulta.
     * 
     * Si la consulta es de tipo SELECT aplican los parametros filtros, informacionOrdenamiento, rangoConsulta
     * y funcionAgrupamiento.
     * 
     * Si la consulta es de tipo UPDATE aplican los parametros filtros e infoAsignaciones.
     * 
     * Si la consulta es de tipo DELETE aplica unicamente el parametro filtros.
     * 
     * @param filtros Las condiciones de filtrado de la consulta. Si es nulo no se aplican condiciones de filtrado.
     * @param informacionOrdenamiento Las condiciones de ordenamiento de la consulta. Si es nulo no se aplican condiciones de ordenamiento.
     * @param infoAsignaciones Las asignaciones a realizar en la actualización. Si es nulo no se aplican asignaciones. Una actualización debe tener 
     * por lo menos una asignación.
     * @param rangoConsulta Rango de registros a seleccionar en la consulta realizada.
     * @param tipoQuery Tipo de query a construir: SELECT, UPDATE o DELETE. No puede ser nulo.
    ...
    /**
     * Setea los valores de parametros de filtrado, de asignación y de rango dependiendo del tipo
     * de query.
     * 
     * @param query El query jpql de consulta con los parámetros pendientes por asignar un valor.
     * @param filters Las condiciones de filtrado de la consulta. Si es nulo no se aplican condiciones de filtrado.
     * @param asignaciones Las asignaciones a realizar en la actualización. Si es nulo no se aplican asignaciones. Una actualización debe tener 
     * por lo menos una asignación.
     * @param rangoConsulta Rango de registros a seleccionar en la consulta realizada.
    ...
    /**
     * Construye una consulta jpql de tipo SELECT con las condiciones de filtrado, ordenamiento y agrupamiento especificadas.
     * 
     * @param filtros Las condiciones de filtrado de la consulta. Si es nulo no se aplican condiciones de filtrado.
     * @param ordenamientos Las condiciones de ordenamiento de la consulta. Si es nulo no se aplican condiciones de ordenamiento.
     * @param infoAgrupamiento Especifica la información de agurpamiento para realizar en las consultas tipo SELECT (COUNT, DISTINCT, NINGUNA).
     * @return El query jpql de consulta con los parámetros pendientes por asignar un valor.
     */
    ...
    /**
     * Construye una consulta jpql de tipo UPDATE con las condiciones de filtrado, y asignación especificadas.
     * @param asignaciones Las asignaciones a realizar en la actualización. Si es nulo no se aplican asignaciones. Una actualización debe tener 
     * por lo menos una asignación.
     * @param filtros Las condiciones de filtrado de la consulta. Si es nulo no se aplican condiciones de filtrado.
     * @return El query jpql de actualización con los parámetros pendientes por asignar un valor.
     */
    ...
    /**
     * Construye una consulta jpql de tipo DELETE con las condiciones de filtrado especificadas.
     * @param filtros Las condiciones de filtrado de la consulta. Si es nulo no se aplican condiciones de filtrado.
     * @return El query jpql de eliminación con los parámetros pendientes por asignar un valor.
     */
    ...
    /**
     * Devuelve la condición de ordenamiento para una consulta jpql a partir de los ordenamientos
     * definidos.
     * @param informacionOrdenamiento Las condiciones de ordenamiento de la consulta. Si es nulo no se aplican condiciones de ordenamiento.
    ...
    /**
     * Devuelve las asignaciones de una actualización jpql (claúsula SET) a partir de las asiganciones
     * definidas.
    ...
    /**
     * Devuelve la asignación como una cadena de caracteres para añadir en una claúsula
     * SET de una actualización jpql. Ej. nombre=:nombre donde :nombre es el parámetro
     * a asignar un valor.
     * 
    ...
    /**
     * Devuelve una condición de filtrado para una consulta jpql a partir de los filtros
     * definidos.
     * @param filtros Filtros previamentes definidos en el query. Si es nulo no 
     * se realiza ninguna asignación.
    ...
    /**
     * Devuelve la condición de filtrado como una cadena de caracteres para añadir en una claúsula
     * WHERE de una consulta jpql. Ej. nombre=:nombre donde :nombre es el parámetro
     * a asignar un valor.
    ...
    /**
     * Obtiene el comparador a utilizar cuando el idReducido del TipoFiltro no concuerda
     * con el utilizado en las consultas jpql.
     ...
     * PK compuesto, seguido del carácter '.' y del nombre del atributo, se reemplaza el '.' por el caracter '_'.
     * 
     * @param nombreAtributo Nombre del atributo a parsear
     * @return El nombre del atributo parseado para su utilización como nombre del parámetro.
     */
