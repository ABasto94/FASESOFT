...
import static com.fasesoft.modelo.utils.UtilReflection.consultarAtributoId;
import static com.fasesoft.modelo.utils.UtilReflection.consultarAtributoPKCompleja;
import static com.fasesoft.modelo.utils.UtilReflection.consultarAtributosClase;
import static com.fasesoft.modelo.utils.UtilReflection.consultarMetodoGetAtributo;
import static com.fasesoft.modelo.utils.UtilReflection.esPkCompleja;
...
public class ManejadorPersistencia<T> implements Serializable {
    ...
    */
    ...
    public List doNativeQuery(String query, List<Object> listaParametros, String mapping){
    ...
    public int doNativeQueryUpdate(String query, List<Object> listaParametros){
